        ...
        <div className="space-y-6">
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2">
              ...
              <li>
                Select the contacts you want to export, or choose "All
                contacts".
              </li>
              <li>
                Choose a location to save the file (e.g., internal storage or SD
                card).
              </li>
              <li>Tap "Save" or "Export".</li>
              <li>
                Transfer the .vcf file to your computer or upload it directly to
                this app.
              </li>
            </ol>
          </section>
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2">
              ...
              <li>
                Send the .vcf file to yourself or directly upload it to this
                app.
              </li>
